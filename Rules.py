class Rule:
    ...
    def createAdjList(self):     
        ...
        adjLists_dict["University Transaction"] = ["amount","statement","university","tuition","fee","student","semester","rates","due","balance","undergraduate","graduate","charges","account","id","edu","aid","scholarships"]
